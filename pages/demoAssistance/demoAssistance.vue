	...
	<view class="container">
		...
		<view class="box1">
			<view class="box1-1">
				...
				<image class="box1-1-2" src="../../static/Rectangle 41052.png" mode=""></image>
		...
		<view class="box3">
			<view class="box3-1 nowrap">风继续吹风继续吹风继续吹风继续吹风继风继续吹风继续吹风继续吹风继续吹风继</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async getDetails() {
				try {
					const res = await this.$post1(collections_index_detail, {
						product_item_id: 180
					})
					console.log(res)
					if (res.code !== 0) {
